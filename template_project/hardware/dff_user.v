...
// Function    : D-type flip-flop with 
//               - asynchronous active high reset
// @note This DFF_user is designed to drive BLs when shift registers are used
//-----------------------------------------------------
module BL_DFFRQ (
  input RST, // Reset input
  input CK, // Clock Input
...
// Function    : D-type flip-flop with 
//               - asynchronous active high reset
// @note This DFF_user is designed to drive WLs when shift registers are used
//-----------------------------------------------------
module WL_DFFRQ (
  input RST, // Reset input
  input CK, // Clock Input
...
// Function    : D-type flip-flop with 
//               - asynchronous active high reset
// @note This DFF_user is designed to drive WLs and WLRs when shift registers are used
//-----------------------------------------------------
module WLR_DFFRQ (
  input RST, // Reset input
  input CK, // Clock Input
